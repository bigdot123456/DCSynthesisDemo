...
set ADDITIONAL_SEARCH_PATH        "../ref/libs/mw_lib/sc/LM  __________  _________ "  ;#  Directories containing logic libraries,
                                                                                       #  logic design and script files.

set TARGET_LIBRARY_FILES          ___________________                   ;#  Logic cell library file
...
set MW_REFERENCE_LIB_DIRS         ../ref/libs/mw_lib/_______            ;#  Milkyway physical cell libraries
