...
set ADDITIONAL_SEARCH_PATH        "../ref/libs/mw_lib/sc/LM ./rtl  ./scripts "  ;#  Directories containing logic libraries,
...
set MW_DESIGN_LIB                TOP                       ;#  User-defined Milkyway design library name

set MW_REFERENCE_LIB_DIRS         ../ref/libs/mw_lib/sc           ;#  Milkyway physical cell libraries, directly to standcell lib
