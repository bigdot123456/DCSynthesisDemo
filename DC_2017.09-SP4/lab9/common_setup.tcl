...
set ADDITIONAL_SEARCH_PATH        "../ref/libs/mw_lib/sc/LM ./unmapped \
				   ./rtl ./scripts"                     ;#  Directories containing logic libraries,
...
set MW_REFERENCE_LIB_DIRS         ../ref/libs/mw_lib/sc                 ;#  Milkyway physical cell libraries
